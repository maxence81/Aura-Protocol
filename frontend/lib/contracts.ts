export const CONTRACT_ADDRESSES = {
  ...
  AURA_PERPS: "0xc12A0864095b2F4Dc0D1aF0169B760c53D59Cb42",
  ...
  AURA_COPY_TRADING_V2: process.env.NEXT_PUBLIC_COPY_TRADING_V2_ADDRESS || "0xa7Cb7800e3882d4Fb82A243473BF61906842292F", // Make sure to load from env
  ...
  LOB_ROUTER:
    ...
    "0x01F94DA2ac90aAeD7f14f64EcaB03a0FAbC2f4B4",
  ROUTER:
    (process.env.NEXT_PUBLIC_LOB_ROUTER_ADDRESS as `0x${string}`) ||
    "0x01F94DA2ac90aAeD7f14f64EcaB03a0FAbC2f4B4",
